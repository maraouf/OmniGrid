...
- Custom-dashboard release-calendar widget — the refresh spinner now reliably shows when you step to the previous / next month (previously it could flash imperceptibly on an already-loaded month, looking like nothing happened).
