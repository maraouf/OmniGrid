...
- **Radarr / Sonarr / Lidarr cards hide Storage at the 3×1 size.** On the custom dashboard, a 3-wide single-row card didn't have room for the per-mount Storage list (it got cut). Storage is now hidden for just those three apps at just that size; every other size and app is unchanged.
