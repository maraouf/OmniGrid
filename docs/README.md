...
| [`guidelines/docker_nodes.md`](guidelines/docker_nodes.md)   | Manage a Portainer-less Docker node directly over SSH (Admin → Docker Nodes) — setup, the per-container actions, known limits, and TrueNAS SCALE specifics.                                                                                                                                                                                                     |
