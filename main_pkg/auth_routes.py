...
async def api_me(request: Request):
    ...
    out = {
        ...
        "client_config": {
            ...
            # New-version watcher poll cadence — seconds in the tunable,
            # delivered as ms so the SPA's startVersionWatcher setInterval
            # keeps its ms-based contract (same shape as ops_poll_ms).
            "version_poll_ms": tuning.tuning_int(Tunable.VERSION_POLL_INTERVAL_SECONDS) * 1000,
