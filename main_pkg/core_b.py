"""Second half of core — split for line-count hygiene.
Chain: main.py → main_pkg.core → main_pkg.core_b → main_pkg.routes
→ ... → main_pkg.routes_extra. core_b loads at the tail of core
so its symbols are in main's namespace before routes' decorators run.
"""
