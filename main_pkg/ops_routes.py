...
class SettingsIn(BaseModel):
    ...
    ai_provider_claude_native_tools: Optional[bool] = None
    ...
    ai_provider_gemini_native_tools: Optional[bool] = None
    ...
    ai_provider_chatgpt_native_tools: Optional[bool] = None
    ...
    ai_provider_deepseek_native_tools: Optional[bool] = None
    ...
    # Host OS-update (osupdate_host) SSH command wall-clock — an apt/yum
