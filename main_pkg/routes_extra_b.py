"""Second half of routes_extra — split for line-count hygiene.
Chain: ... → main_pkg.routes_extra → main_pkg.routes_extra_b →
(back to routes_extra epilogue: StaticFiles mount).
routes_extra_b loads BEFORE the StaticFiles catch-all so any new
routes it registers still beat the static mount.
"""
