"""Second half of routes_late — split for line-count hygiene.
Star-import chain: main_pkg.routes_late → main_pkg.routes_late_b
→ main_pkg.routes_extra. See routes_extra docstring for context.
"""
...
# Trigger routes_extra's load at the tail so chain stays intact.
