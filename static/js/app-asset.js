...
//
// Surface includes:
//   - Form state (assetForm, assetStatus, assetTestResult, ...)
//   - Test-before-Save gate (`_assetSnapshot`, `canSaveAsset`,
//     `_assetLastPassedTest`)
//   - CRUD (`loadAssetCache`, `refreshAssetCache`, `saveAssetSettings`)
//   - Per-host lookups (`assetForHost`, `assetEditUrl`,
//     `assetPortServiceUrl`)
//
// Phase 2, Batch 6 of the static/js/app.js modularisation.
