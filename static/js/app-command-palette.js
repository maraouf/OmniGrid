...
//
// Surface:
//   - State (`commandPaletteOpen`, `commandPaletteQuery`,
//     `commandPaletteSelectedIdx`, `commandPaletteBulkExcluded`)
//   - Activation + navigation (`commandPaletteActivate`,
//     `commandPaletteMove`)
//   - Action discovery (`_commandActions`, `_actionDescriptorById`,
//     `commandPaletteResults`, `commandPaletteBulkState`)
//   - Bulk parsing (`_commandPaletteParseBulk`,
//     `_commandPaletteBulkMatchHost`)
//   - Action execution (`_runCommandPaletteAction`)
//
// The AI palette mode (`_runCommandPaletteAi`, `_runCommandPaletteAiBulk`)
// lives in `app-ai.js`.
//
// Phase 2, Batch 21 of the static/js/app.js modularisation.
