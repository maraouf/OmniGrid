...
//
// Surface:
//   - State: `hostsSearch`, `hostsSort`, `hostsFilter*`, `hostsHide*`,
//     `hostsExpanded`, `hostsProviderFilter`, host data arrays
//   - Loader + reconcile: `loadHosts`, `refreshHostRow`,
//     `_ensureHostRowObserver`
//   - Filters + sort + grouping: `filteredHosts`, `groupedHosts`
//   - Per-host derived helpers: `host{Has,Disk,Mem,Display,Failure,
//     LastFailure,Collector,Spark,Drift,Baseline,Stats,Inline,Metric,
//     Ping}*`, `providerStates`
//   - Bulk ops fan-out: `_hostsBulkPost`
//   - Timeline + triage + debug expander:
//     `loadHostTimeline`, `loadHostTriage`, `setHostTimelineRange`,
//     `toggleHostDebug`, `loadHostBeszelServices`
//   - Row expand/collapse: `isHostExpandable`, `isHostExpanded`,
//     `toggleHostsProviderFilter`
//
// Phase 2, Batch 25 of the static/js/app.js modularisation.
