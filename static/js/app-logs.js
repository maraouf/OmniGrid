...
//
// Two sub-tabs:
//   1. Live — `logLines`, `loadLogs`, `clearLogs`, severity filtering,
//      filter chip stripe + colour-coding via `colorizeLogText`
//      (kept in `app-utils.js`).
//   2. Files — `logFiles`, `loadLogFiles`, `logFileBody`, auto-tail
//      polling (`logFileAutoTail`, `_logFileTimer`), per-file severity
//      counts.
//
// Phase 2, Batch 17 of the static/js/app.js modularisation.
