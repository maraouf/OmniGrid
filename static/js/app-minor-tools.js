...
// auto-fix actions.
//
// Three small but distinct features that share a "small bounded feature
// per host / per item" shape:
//   - Port scan: `runPortScan`, `portScanChipClass`,
//     `portScanChipTitle`, `portScanShouldFlag`,
//     `_openPortScanHistoryDetail`, `_inFlightPortScans`
//   - Retag popover (UI for changing an item's image tag from the row
//     menu): `openRetagPopover`, `submitRetagPopover`,
//     `_retagPopoverStyle`, `_retagPopoverItemId`,
//     `_retagPopoverPos`, `_retagBusy`, `_retagDraft`, `_retagScrollOff`
//   - Task-error auto-fix: `taskErrorAutoFixActions`,
//     `runTaskErrorAutoFix`, `taskErrorKnownIssue`
//
// Phase 2, Batch 30 of the static/js/app.js modularisation.
