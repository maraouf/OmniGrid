...
export default {
  ...
  notificationsPage() {
    return Math.floor((this.notificationsOffset || 0) / (this.notificationsLimit || 25)) + 1;
  },
  ...
  notificationsHasNext() {
    return this.notificationsPage() < this.notificationsPageCount();
  },
  notificationsHasPrev() {
    return (this.notificationsOffset || 0) > 0;
  },
