...
export default {
  ...
  notifyEventKeys: [
    ...
    'notify_event_service_rollback_success',
    'notify_event_service_rollback_failure',
  ...
  notifyEventGroups: [
    ...
    {label: 'service_rollback', success: 'notify_event_service_rollback_success', failure: 'notify_event_service_rollback_failure'},
