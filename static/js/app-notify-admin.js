...
//
// Surface:
//   - Apprise gate: `appriseDirty`, `_appriseSnapshot`, `canSaveApprise`,
//     `testApprise`
//   - Per-event / per-medium matrix: `notifyEventKeys`, `notifyMediumKeys`,
//     `notifyCategories*`, `toggleNotifyCategory*`, `setAllNotifyEvents`,
//     `setNotifyEventsErrorsOnly`
//   - Template editor: `notifyTemplateEditor`, `openNotifyTemplateEditor`,
//     `closeNotifyTemplateEditor`, `saveNotifyTemplate`,
//     `refreshNotifyTemplatePreview`, `insertNotifyTemplatePlaceholder`,
//     `testNotifyTemplate`
//   - Tab strip: `notificationsTab`, `setNotificationsTab`
//   - Central save: `saveSettings` (Admin → Notifications POST)
//
// Phase 2, Batch 24 of the static/js/app.js modularisation.
