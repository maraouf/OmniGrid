...
//
// Surface:
//   - State: `activeOps`, `opsExpanded`, `history`, `historyFilters`,
//     `historyPage`, `historyPerPage`, `historyTotal`, `_historyFetchSeq`
//   - Polling: `pollOps`, `pollOpsNow`
//   - Op metadata helpers: `opStatusLabel`, `opTypeLabel`
//   - History: `loadHistory`, `_historyQueryParams`, `historyApplyFilter`,
//     `historyExportUrl`, `historyGoToPage`, `historyNextPage`,
//     `historyPrevPage`, `historySetPerPage`, `historyStackOptions`,
//     `historyTotalPages`, `openHistoryDetail`
//   - Single-item actions + bulk action fan-out: `itemAction`,
//     `_bulkRemoveItems`, `_bulkUpdateItems`, `bulkRemove`, `bulkRemoveAll`,
//     `bulkRestart`, `bulkUpdate`, `bulkUpdateAll`
//
// Phase 2, Batch 27 of the static/js/app.js modularisation.
