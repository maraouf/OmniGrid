...
//
// CRUD + run-now + status helpers for the cron-like scheduler:
//   - `loadSchedules` / `saveSchedule` / `deleteSchedule` /
//     `toggleScheduleEnabled` / `editSchedule` / `runSchedule`
//   - Modal form state (`newSchedule`, `editingSchedule`, `scheduleKinds`)
//   - Paginated queue view (`scheduleQueue*` family)
//   - Scheduler-global settings (`saveSchedulerSettings`)
//
// Phase 2, Batch 12 of the static/js/app.js modularisation.
