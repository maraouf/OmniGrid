...
//
// Three sub-surfaces here, all consumed via the SSH card on the host
// drawer:
//   1. Settings editor (`sshSettings`, `hydrateSshSettings`,
//      `saveSshSettings`, custom-action CRUD).
//   2. One-shot command runner (`runSshCommand`, `sshResult`, dry-run
//      toggle, `copySshOutput`).
//   3. Interactive xterm.js terminal modal (`_spawnTerminal`,
//      `openHostTerminal`, `closeHostTerminal`, `reconnectHostTerminal`,
//      WebSocket lifecycle, FitAddon resize ladder).
//
// Phase 2, Batch 10 of the static/js/app.js modularisation.
