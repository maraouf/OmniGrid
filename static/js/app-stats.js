...
//
// Surface:
//   - State: `stats`, `statsTab`, `statsLoaded`, `statsInterval`,
//     `statsRefreshing`, per-sub-tab data + ranges, `sparks`
//   - Loaders: `loadStats`, `loadStatsOverview`, `loadStatsDatabase`,
//     `loadStatsNetwork`, `loadStatsIncidents`, `loadStatsSamples`,
//     `loadSparks`
//   - Helpers: `samplesWindowRows`, `_statsSamplesSorted`,
//     `_statsSamplesSortIndicator`, `statsFor`, `statsDebug`,
//     `whyNoGraphs`, `statsNetworkRangeLabel`
//   - Nodes view: `nodeGroups`, `nodeStats`, `nodeSparkPoints`,
//     `nodeSparkClass`
//
// Phase 2, Batch 28 of the static/js/app.js modularisation.
