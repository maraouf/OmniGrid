...
//
// CRUD + bulk-edit for the three auth admin surfaces:
//   - Users: `loadUsers`, `createUser`, `patchUser`, `deleteUser`,
//     `toggleUserDisabled`, `toggleUserRole`, `resetUserPassword`
//   - Per-user notification opt-in matrix: `setAllUserNotifyEvents`,
//     `setUserNotifyEventValue`, `setUserNotifyEventsByMediumPattern`,
//     `setUserNotifyEventsErrorsOnly`, `toggleUserNotifyEventRow`,
//     `toggleUserNotifyMediumColumn`
//   - Sessions: `loadSessions`, `revokeSession`
//   - API Tokens: `loadTokens`, `createToken`, `deleteToken`, plus the
//     one-time reveal pane state (`lastCreatedToken`).
//
// Phase 2, Batch 13 of the static/js/app.js modularisation.
