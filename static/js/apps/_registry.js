...
const _modules = [adguardHome, adguardHomeSync, apc, apprise, bazarr, ddnsUpdater, kavita, lidarr, pihole, plex, prowlarr, qbittorrent, radarr, readarr, seerr, sonarr, speedtestTracker, tautulli, tracearr];
