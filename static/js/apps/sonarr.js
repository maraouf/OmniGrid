...
// every Alpine flush).
const _sonarrTrendMemo = new WeakMap();
...
function sonarrTrendPath(arr) {
  if (!Array.isArray(arr) || arr.length < 2) {
    return '';
  }
  if (_sonarrTrendMemo.has(arr)) {
    return _sonarrTrendMemo.get(arr);
  }
...
export const helpers = {
  ...
  sonarrGb: sonarrGb,
  sonarrTrend: sonarrTrend,
  sonarrTrendPath: sonarrTrendPath,
};
